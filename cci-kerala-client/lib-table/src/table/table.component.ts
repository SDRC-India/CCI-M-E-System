...
import { DashboardServiceService } from 'src/app/pages/dashboard/dashboard-service.service';
declare var $: any;
...
export class TableComponent implements OnInit, OnChanges {
  ...
  @Input() checboxText: string;

  checboxValue:boolean=false;
  ...
  @Output() checkboxSelected: EventEmitter<any> = new EventEmitter<any>();
  ...
  checkboxChange()
  {
    this.checkboxSelected.emit(this.checboxValue)
  }
