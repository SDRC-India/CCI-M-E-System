...
public class QuestionModel implements Cloneable{
	...
	private List<List<QuestionModel>> childQuestionModels;
	...
	public List<List<QuestionModel>> getChildQuestionModels() {
		return childQuestionModels;
	}

	public void setChildQuestionModels(List<List<QuestionModel>> childQuestionModels) {
